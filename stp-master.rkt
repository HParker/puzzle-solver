...
(module+ main
  ...
  ;#|
  (define search-result (time (cfs-file (make-fringe-from-files "fringe-segment-d136-" 90 "/share/bigspace/fringefiles/")
                                        (make-fringe-from-files "fringe-segment-d137-" 90 "/share/bigspace/fringefiles/")
                                        138)))
  ;|#
  #|
